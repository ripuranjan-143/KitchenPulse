...
function SignUp() {
  ...
  return (
    <div className="min-h-screen w-full flex justify-center p-4 pb-6 bg-[#fff9f6]">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-8 border border-gray-300">
        ...
        <p className="text-center mt-6">
          Already have an account ? <span className="text-[#ff4d2d] cursor-pointer">Sign In</span>
        </p>
      </div>
    </div>
  );
